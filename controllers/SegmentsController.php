<?php
class SegmentsController extends ControllerBase
{
    /*******************************************************************************
    * SEGMENTS
    *******************************************************************************/
    ...
    //SHOW
    public function segmentsDt($error_flag = 0, $message = "")
    {
        ...
        //Titulo pagina
        $data['titulo'] = "SEGMENTS";

        $data['controller'] = "segments";
        $data['action'] = "segmentsEditForm";
    ...
    public function segmentsAdd()
    {
            ...
            if(strval($_POST['form_timestamp']) == strval($session->orig_timestamp))
            {
                    ...
                    $cod_segment = $_POST['txtcodigo'];
                    $name_segment = $_POST['txtnombre'];
                    $cod_gbu = $_POST['txtgbu'];
    ...
    public function segmentsEditForm()
    {
            if($_POST)
            {
                    $data['cod_segment'] = $_POST['txtcodigo'];
                    $data['name_segment'] = $_POST['txtnombre'];
                    $data['cod_gbu'] = $_POST['txtgbu'];
    ...
    public function segmentsEdit()
    {
            ...
            if(strval($_POST['form_timestamp']) == strval($session->orig_timestamp))
            {
                    ...
                    $name_segment = $_POST['txtnombre'];
                    $cod_gbu = $_POST['txtgbu'];
                    $old_cod_segment = $_POST['old_code'];
                    $old_name_segment = $_POST['old_name'];
                    $old_gbu = $_POST['old_gbu'];
