	...
	<div id="central">
		<div id="contenido">
            ...
            <table class="display" id="example">
                <thead>
                    <tr class="headers">
                        <th>COD SUB SEGMENT</th>
                        <th>NAME SUB SEGMENT</th>
                        <th>GBU</th>
                        <th>OPTIONS</th>
                    </tr>
                </thead>
                ...
                <tr>
                    ...
                    <td><?php echo $item['COD_SUB_SEGMENT'];?></td>
                    <td><?php echo $item['NAME_SUB_SEGMENT'];?></td>
                    <td><?php echo $item['GBU_NAME_GBU'];?></td>
                    <td>
                    	<form method="post"  action="<?php echo $rootPath.'?controller=segments&amp;action=subSegmentsEditForm';?>">
                                <?php 
                                echo "<input name='txtcodigo' type='hidden' value='$item[COD_SUB_SEGMENT]' />\n";
                                echo "<input name='txtnombre' type='hidden' value='$item[NAME_SUB_SEGMENT]' />\n";
