    ...
    <div id="contenido">
        ...
        <table class="display" id="example">
            ...
            <tr>
                ...
                <td><?php echo $item['COD_COMUNA'];?></td>
                <td><?php echo $item['NOM_COMUNA'];?></td>
                <td>
                    <form method="post"  action="<?php echo $rootPath.'?controller='.$controller.'&amp;action='.$action.'';?>">
                    <?php 
                        echo "<input name='code' type='hidden' value='$item[COD_COMUNA]' />\n";
                        echo "<input name='name' type='hidden' value='$item[NOM_COMUNA]' />\n";
                        echo "<input name='code_b' type='hidden' value='$item[CIUDAD_COD_CIUDAD]' />\n";
                        echo "<input name='code_c' type='hidden' value='$item[CIUDAD_REGION_COD_REGION]' />\n";
