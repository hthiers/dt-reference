    ...
    <div id="contenido">
        ...
        <table class="display" id="example">
            ...
            <tr>
                ...
                <td><?php echo $item['COD_ZONA'];?></td>
                <td><?php echo $item['NOM_ZONA'];?></td>
                <td>
                    <form method="post"  action="<?php echo $rootPath.'?controller=tiendas&amp;action=zonasEditForm';?>">
                    <?php 
                        echo "<input name='code' type='hidden' value='$item[COD_ZONA]' />\n";
                        echo "<input name='name' type='hidden' value='$item[NOM_ZONA]' />\n";
