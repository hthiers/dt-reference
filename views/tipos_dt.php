    ...
    <div id="contenido">
        ...
        <table class="display" id="example">
            ...
            <tr>
                ...
                <td><?php echo $item['COD_TIPO'];?></td>
                <td><?php echo $item['NOM_TIPO'];?></td>
                <td>
                    <form method="post"  action="<?php echo $rootPath.'?controller=tiendas&amp;action=tiposEditForm';?>">
                    <?php 
                        echo "<input name='code' type='hidden' value='$item[COD_TIPO]' />\n";
                        echo "<input name='name' type='hidden' value='$item[NOM_TIPO]' />\n";
