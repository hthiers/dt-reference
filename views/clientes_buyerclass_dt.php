...
?>
    ...
    <div id="contenido">
        ...
        <table class="display" id="example">
            <thead>
                <tr class="headers">
                    <th>COD BUYER CLASS</th>
                    <th>NOMBRE BUYER CLASS</th>
                    <th>OPTIONS</th>
                </tr>
            </thead>
            <tbody>
            ...
            <tr>
                ...
                <td><?php echo $item['COD_BUYER_CLASS'];?></td>
                <td><?php echo $item['BUYER_CLASS_NAME'];?></td>
                <td>
                    <form method="post"  action="<?php echo $rootPath.'?controller='.$controller.'&amp;action='.$action.'';?>">
                    <?php 
                        echo "<input name='code' type='hidden' value='$item[COD_BUYER_CLASS]' />\n";
                        echo "<input name='name' type='hidden' value='$item[BUYER_CLASS_NAME]' />\n";
