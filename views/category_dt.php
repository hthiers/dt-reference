...
?>
    ...
    <div id="contenido">
        ...
        <table class="display" id="example">
            ...
            ?>
                <tr>
                    <td><?php echo $item['COD_CATEGORY'];?></td>
                    <td><?php echo $item['NAME_CATEGORY'];?></td>
                    <td><?php echo $item['BU_NAME_BU'];?></td>
                    <td>
                        <form method="post"  action="<?php echo $rootPath.'?controller='.$controller.'&amp;action='.$action.'';?>">
                        <?php 
                            echo "<input name='code' type='hidden' value='$item[COD_CATEGORY]' />\n";
                            echo "<input name='code_b' type='hidden' value='$item[BU_COD_BU]' />\n";
                            echo "<input name='name' type='hidden' value='$item[NAME_CATEGORY]' />\n";
