	...
	<div id="central">
        <div id="contenido">
            ...
            if($debugMode)
            {
                ...
                print_r($action_b);print("<br />");print_r($lista_categoria);print("<br />");
                print('</div>');
            }
            ?>
            <!-- END DEBUG -->
            ...
            <form id="moduleForm" name="form1" method="post"  action="<?php echo $rootPath.'?controller='.$controller.'&amp;action='.$action.'';?>">
              <table width="457" height="118" border="0" align="center" class="texto">
                 ...
                 <input name="formulario" type="hidden" value="SEGMENT" />
                  ...
                  <td width="380">
                      <?php
                        ...
                        while($row = $lista_categoria->fetch(PDO::FETCH_ASSOC))
                        {
                ...
                <tr>
                 ...
                 <td>C&oacute;digo</td>
                  <td>:</td>
                  <td><input minlength="2" name="code" type="text" id="txtcodigo" size="40"  value="" /></td>
                </tr>
                <tr>
                  <td>Nombre</td>
                  <td>:</td>
                  <td><input minlength="2" name="name" type="text" id="txtnombre" size="40" /></td>
                </tr>
                <tr>
                  <td colspan="3">
