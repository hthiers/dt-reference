...
?>
	...
	<div id="central">
        <div id="contenido">
            ...
            <form id="moduleForm" name="form1" method="post"  action="<?php echo $rootPath.'?controller=segments&amp;action=segmentsEdit';?>">
              <table width="457" height="118" border="0" align="center" class="texto">
                <tr>
                    <td width="56">C&oacute;digo</td>
                  <td width="3">:</td>
                  <td width="380"><input minlength="1" name="txtcodigo" type="text" id="txtcodigo" size="40"  value="<?php echo $cod_segment; ?>" readonly="readonly"/></td>
                </tr>
                <tr>
                  <td>Nombre</td>
                  <td>:</td>
                  <td><input minlength="2" name="txtnombre" type="text" id="txtnombre" size="40" value="<?php echo $name_segment; ?>" /></td>
                </tr>
                <tr>
                  ...
                  <td>
                        ...
                        echo "</select>\n";
                        ?>
                    <input name="old_code" type="hidden" id="old_code" value="<?php echo $cod_segment; ?>" />
                    <input name="old_name" type="hidden" id="old_name" value="<?php echo $name_segment; ?>" />
