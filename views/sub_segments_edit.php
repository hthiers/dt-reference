...
?>
	...
	<div id="central">
		<div id="contenido">
            ...
            <form id="moduleForm" name="form1" method="post"  action="<?php echo $rootPath.'?controller=segments&amp;action=subSegmentsEdit';?>">
              <table width="457" height="118" border="0" align="center" class="texto">
                <tr>
                    <td width="56">C&oacute;digo</td>
                  <td width="3">:</td>
                  <td width="380"><input minlength="1" name="txtcodigo" type="text" id="txtcodigo" size="40"  value="<?php echo $code; ?>" readonly="readonly"/></td>
                </tr>
                <tr>
                  <td>Nombre</td>
                  <td>:</td>
                  <td><input minlength="1" name="txtnombre" type="text" id="txtnombre" size="40" value="<?php echo $name; ?>" /></td>
                </tr>
                <tr>
