            ...
            <form id="moduleForm" name="form1" method="post"  action="<?php echo $rootPath.'?controller='.$controller.'&amp;action='.$action.'';?>">
              <table width="457" height="118" border="0" align="center" class="texto">
                <tr>
                  ...
                  <td width="3">:</td>
                  <td>
                  	<input class="required" minlength="3" name="code" type="text" id="txtcodigo" size="40" />
                  </td>
                </tr>
                <tr>
                  <td>Modelo Sufijo</td>
                  <td>:</td>
                  <td><input class="required" minlength="4" name="code_suffix" type="text" id="txtcodigo" size="40" /></td>
                </tr>
                <tr>
                <tr>
                  <td>Estado</td>
