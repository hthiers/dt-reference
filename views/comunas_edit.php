...
?>
    ...
    <div id="contenido">
            ...
            if($debugMode)
            {
                ...
                print_r($titulo);print("<br />");print_r($code);print("<br />");
                print_r($code_b);print("<br />");
                print_r($name);print("<br />");print_r($controller);print("<br />");
             ...
             <form id="moduleForm" name="form1" method="post"  action="<?php echo $rootPath.'?controller='.$controller.'&amp;action='.$action.' ';?>">
              <table width="457" height="118" border="0" align="center" class="texto">
                ...
                <tr>
                  <td colspan="3">
                    <br />
                    <input name="code_b" type="hidden" id="oculto" value="<?php echo $code_b; ?>" />
                    <input name="code_c" type="hidden" id="oculto" value="<?php echo $code_c; ?>" />
