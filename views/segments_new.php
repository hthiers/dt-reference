...
?>
	...
	<div id="central">
        <div id="contenido">
            ...
            <form id="moduleForm" name="form1" method="post"  action="<?php echo $rootPath.'?controller=segments&amp;action=segmentsAdd';?>">
              <table class="texto">
                <tr>
                 <input name="formulario" type="hidden" value="SEGMENT" />
                 <td width="56">C&oacute;digo</td>
                  <td width="3">:</td>
                  <td><input name="txtcodigo" type="text" id="txtcodigo" size="40"  value="<?php echo $segment_code; ?>" readonly="readonly"/>
                  <input type="hidden" name="oculto" id="oculto" value="<?php echo $segment_code; ?>" />
                </tr>
                <tr>
                  <td>Nombre</td>
                  <td>:</td>
