              ...
              <table width="457" height="118" border="0" align="center" class="texto">
                <tr>
                 ...
                 <td width="56">C&oacute;digo</td>
                  ...
                  <input type="hidden" name="oculto" id="oculto" value="<?php echo $new_code; ?>" />
                  <input type="checkbox" name="noaplica" id="noaplica" /> <label class="fin">(No Aplica)</label>  <label for="n/a"></label></td>
                </tr>
                <tr>
                  <td>Nombre</td>
                  <td>:</td>
                  <td><input class="required" minlength="3" name="name" type="text" id="txtnombre" size="40" /></td>
                </tr>
                <tr>
                  <td colspan="3"><br /></td>
                </tr>
