    ...
    <div id="contenido">
        ...
        <table class="display" id="example">
            ...
            <tr>
                ...
                <td><?php echo $item['COD_REGION'];?></td>
                <td><?php echo $item['NOM_REGION'];?></td>
                <td>
                    <form method="post"  action="<?php echo $rootPath.'?controller='.$controller.'&amp;action='.$action.'';?>">
                    <?php 
                        echo "<input name='code' type='hidden' value='$item[COD_REGION]' />\n";
                        echo "<input name='name' type='hidden' value='$item[NOM_REGION]' />\n";
