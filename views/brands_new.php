        ...
        $("#moduleForm").validate({
            rules: {
                ...
                name: {
                    required: true,
                    remote: {
                        url: <?php echo "'".$rootPath."?controller=brands&action=verifyNameBrand'";?>,
                        type: "POST",
                        data: {
                            name: function() {
            ...
            <form id="moduleForm" name="form1" method="post"  action="<?php echo $rootPath.'?controller='.$controller.'&amp;action='.$action.'';?>">
              <table width="457" height="118" border="0" align="center" class="texto">
                <tr>
                    ...
                    <td width="3">:</td>
                    <td width="380"><input name="code" type="text" id="txtcodigo" size="40"  value="<?php echo $new_code; ?>" readonly="readonly" /></td>
                </tr>
                <tr>
                  <td>Nombre</td>
                  <td>:</td>
                  <td><input name="name" type="text" id="txtnombre" size="40" /></td>
                </tr>
                <tr>
                  <td colspan="3">
