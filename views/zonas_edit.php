...
?>
    ...
    <div id="contenido">
        	...
        	<form id="moduleForm" name="form1" method="post"  action="<?php echo $rootPath.'?controller=tiendas&amp;action=zonasEdit';?>">
              <table width="457" height="118" border="0" align="center" class="texto">
                <tr>
                    <td width="56">C&oacute;digo</td>
                  <td width="3">:</td>
                  <td width="380">
                    <input class="required" minlength="1" name="code" type="text" id="txtcodigo" size="40"  value="<?php echo $code; ?>" readonly/>
                  </td>
                </tr>
                <tr>
                  <td>Nombre</td>
                  <td>:</td>
                  <td><input class="required" minlength="1" name="name" type="text" id="txtnombre" size="40" value="<?php echo $name; ?>" /></td>
                </tr>
                <tr>
                  <td colspan="3">
                    <br />
