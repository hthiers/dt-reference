    ...
    <div id="contenido">
        ...
        <table class="display" id="example">
            ...
            <tr>
                ...
                <td><?php echo $item['COD_ESTADO'];?></td>
                <td><?php echo $item['NAME_ESTADO'];?></td>
                <td>
                    <form method="post"  action="<?php echo $rootPath.'?controller='.$controller.'&amp;action='.$action.'';?>">
                    <?php 
                        echo "<input name='code' type='hidden' value='$item[COD_ESTADO]' />\n";
                        echo "<input name='name' type='hidden' value='$item[NAME_ESTADO]' />\n";
